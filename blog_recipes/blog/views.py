...
def add_recipe(request):
    ...
    return render(request, 'blog/add_recipe.html', context=context)
...
def show_recipe(request, recipe_id):
    ...
    return render(request, 'blog/recipe.html', context=context)
...
def change_recipe(request, recipe_id: int):
    ...
    return render(request, "blog/change_recipe.html", context=context)
...
def show_comments_recipe(request, recipe_id):
    ...
    return render(request, 'blog/show_comments_recipe.html', context=context)
...
def delete_recipe(request, recipe_id):
    ...
    return render(request, 'blog/delete_recipe.html', context=context)
...
def show_user_recipes(request):
    ...
    return render(request, 'blog/user_recipes.html', context=context)
