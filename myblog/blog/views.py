...
from django.contrib.postgres.search import TrigramSimilarity # Триграммный поиск
    ...
    if 'query' in request.GET:
        ...
        if form.is_valid():
            ...
            results = Post.published.annotate(
              ...
              # .filter(rank__gte=0.3).order_by('-rank') фильтрация по рангу более 0.3 

            # Реализация поиска по триграммному поиску
            # results = Post.published.annotate(
